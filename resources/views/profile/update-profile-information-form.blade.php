<x-jet-form-section submit="updateProfileInformation">
    <x-slot name="title">
        {{ __('pages.profile.profile_information') }}
    </x-slot>

    <x-slot name="description">
        {{ __('pages.profile.profile_information_description') }}
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="title" value="{{ __('general.columns.title') }}" />
        ...
        <!-- First Name -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="first_name" value="{{ __('general.columns.first_name') }}" />
        ...
        <!-- Middle Name -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="middle_name" value="{{ __('general.columns.middle_name') }}" />
        ...
        <!-- Last Name -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="last_name" value="{{ __('general.columns.last_name') }}" />
